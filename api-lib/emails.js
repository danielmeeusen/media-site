               ...
               <tr>
                 <td>
                   <table 
                     width="95%" 
                     align="center" 
                     style="max-width: 800px; text-align:center; background: lightgray; border-radius: 15px; box-shadow: 0 6px 18px 0 rgba(0,0,0,.06);"
                    >
                     <tr>
                       <td style="padding:0 18px;">
                         ...
                         <a 
                           ...
                           href="${link}"
                           style="background:MediumOrchid; text-decoration:none !important; font-weight:400; margin:20px; color:#fff; padding:10px; display: inline-block; border-radius: 30px; width:65%"
                            >
                           ${button}
                         </a>
